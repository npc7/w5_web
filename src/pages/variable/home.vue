...
<a-layout-content>
    ...
    <a-table rowKey="id" :columns="columns" :data-source="data" :loading="loading">
        ...
        <a-tag slot="type_name" slot-scope="text" color="#7d838c">
            {{ text }}
        </a-tag>
    ...
    <a-drawer title="添加新变量" :width="300" :visible="visible_add" :body-style="{ paddingBottom: '80px' }" @close="onCloseAdd">
    ...
    <a-drawer title="更新变量信息" :width="300" :visible="visible_edit" :body-style="{ paddingBottom: '80px' }" @close="onCloseEdit">
